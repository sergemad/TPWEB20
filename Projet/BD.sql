...
INSERT INTO film VALUES('1', 'ALL EYEZ ON ME', 'En 1995, dans la prison de Dannemora, un réalisateur et son équipe viennent interviewer Tupac Shakur, incarcéré pour quelques mois. Il leur raconte son enfance, sa relation avec sa mère Afeni, ses débuts dans le rap ou encore ses débuts au cinéma.','2017', 'Qui émeut', '2h 20 min', 'Benny Boom','https://cdn.hmv.com/r/w-1280/hmv/files/c4/c4dfbd96-be7a-41fa-81c4-598d87f96bde.jpg');
INSERT INTO film VALUES('2', 'DJANGO UNCHAINED', ' Un cavalier solitaire s interpose dans la guerre que se livrent un général américain et un aventurier mexicain','1966', 'Qui inspire', '1h 33min', 'Quentin Tarantino','https://fr.web.img6.acsta.net/medias/nmedia/18/90/08/59/20366454.jpg');
INSERT INTO film VALUES('3', 'MAD MAX FURY ROAD', 'Hanté par un lourd passé, Mad Max estime que le meilleur moyen de survivre est de rester seul. Cependant, il se retrouve embarqué par une bande qui parcourt le désert à bord d un véhicule militaire piloté par l Impératrice Furiosa. Ils fuient la Citadelle où sévit le terrible Immortan Joe qui s est fait voler un objet irremplaçable. Enragé, ce Seigneur de guerre envoie ses hommes pour traquer les rebelles impitoyablement...','2015', 'Qui surprend', '2h 0 min', 'GEORGE MILLER','https://fr.web.img3.acsta.net/pictures/15/04/14/18/30/215297.jpg');
